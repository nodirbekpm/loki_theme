        ...
        <div class="catalog-wrap">
            <div class="catalog__blocks">
                ...
                foreach ($catalogs as $catalog) :
                    ...
                    $card_title = $card['title'] ?? get_the_title($catalog); // fallback
                    $card_image = $card['image'];
                    $product_count = 0;

                    // Shu katalogga bog‘langan barcha kategoriyalarni topamiz
                    $categories = get_posts([
                        'post_type' => 'product_category',
                        'meta_key' => 'catalog', // ACF field nomi
                    ...
                    if ($categories) {
                        // Barcha productlarni olib tekshiramiz
                        $products = get_posts([
                            'post_type' => 'product',
                            'posts_per_page' => -1,
                            'post_status' => 'publish',
